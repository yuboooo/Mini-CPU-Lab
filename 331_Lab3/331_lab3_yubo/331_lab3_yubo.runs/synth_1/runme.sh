...
HD_PWD='E:/CMPEN 331 Vivado Lab/331_Lab3/331_lab3_yubo/331_lab3_yubo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IFID_IDEXE_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IFID_IDEXE_Module.tcl
